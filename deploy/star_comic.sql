...
BEGIN
    LOOP
        ...
        BEGIN
            INSERT INTO "1".comic_geek (comic_id, geek_id, is_starred)
...
GRANT EXECUTE ON FUNCTION "1".star_comic(TEXT, INTEGER, BOOLEAN) TO maestro;
