...
CREATE OR REPLACE FUNCTION cg.update_strip(
    _id UUID,
    _comic_id UUID,
    _title VARCHAR(63),
    _number INTEGER,
...
GRANT EXECUTE ON FUNCTION cg.update_strip(UUID, UUID, VARCHAR, INTEGER, VARCHAR, VARCHAR, VARCHAR, VARCHAR, TEXT) TO lurker;
