...
BEGIN
    LOOP
        ...
        BEGIN
            INSERT INTO cg.strip_geek (strip_id, geek_id, is_starred)
...
GRANT EXECUTE ON FUNCTION cg.star_strip(INTEGER, INTEGER, BOOLEAN) TO maestro;
